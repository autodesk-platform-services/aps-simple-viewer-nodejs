...
export const MetadataApiAxiosParamCreator = function (apsConfiguration?: IApsConfiguration) {
    return {
         ...
         */
        fetchSpecificProperties: async (accessToken: string, urn: string, modelGuid: string,region?:Region, acceptEncoding?: string, specificPropertiesPayload?: SpecificPropertiesPayload,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAllProperties: async (accessToken: string, urn: string, modelGuid: string,region?: Region, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, objectid?: number, forceget?: string,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'urn' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getModelViews: async (accessToken: string, urn: string, region?: Region, acceptEncoding?: string,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'urn' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getObjectTree: async (accessToken: string, urn: string, modelGuid: string,region?: Region, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, forceget?: string, objectid?: number, level?: string,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'urn' is not null or undefined
...
export const MetadataApiFp = function(sdkManager?: SDKManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchSpecificProperties(accessToken: string, urn: string, modelGuid: string,region?:Region,  acceptEncoding?: string, specificPropertiesPayload?: SpecificPropertiesPayload, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SpecificProperties>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchSpecificProperties(accessToken, urn, modelGuid,region, acceptEncoding, specificPropertiesPayload,  options);
         ...
         * @throws {RequiredError}
         */
        async getAllProperties(accessToken: string, urn: string, modelGuid: string,region?:Region, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, objectid?: number, forceget?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllProperties>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProperties(accessToken, urn, modelGuid,region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget,  options);
            return createRequestFunction(localVarAxiosArgs, sdkManager);
        },
        /**
         * Returns a list of Model Views (Viewables) in the source design specified by the ``urn`` parameter. It also returns an ID that uniquely identifies the Model View. You can use these IDs with other metadata operations to obtain information about the objects within those Model Views.  Designs created with applications like Fusion 360 and Inventor contain only one Model View per design. Applications like Revit allow multiple Model Views per design.  **Note:** You can retrieve metadata only from a design that has already been translated to SVF or SVF2.
         ...
         * @throws {RequiredError}
         */
        async getModelViews(accessToken: string, urn: string, region?:Region,acceptEncoding?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModelViews>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getModelViews(accessToken, urn,region, acceptEncoding,  options);
            return createRequestFunction(localVarAxiosArgs, sdkManager);
        },
        /**
         * Retrieves the structured hierarchy of objects, known as an object tree, from the specified Model View (Viewable) within the specified source design. The object tree represents the arrangement and relationships of various objects present in that Model View.  **Note:** A design file must be translated to SVF or SVF2 before you can retrieve its object tree.    Before you call this operation:  - Use the `List Model Views </en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET/>`_ operation to obtain the list of Model Views in the source design. - Pick the ID of the Model View you want to query and specify that ID as the value for the ``modelGuid``  parameter. 
         ...
         * @throws {RequiredError}
         */
        async getObjectTree(accessToken: string, urn: string, modelGuid: string, region?:Region,acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, forceget?: string, objectid?: number, level?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectTree>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getObjectTree(accessToken, urn, modelGuid, region,acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level,  options);
            return createRequestFunction(localVarAxiosArgs, sdkManager);
        },
    }
};
...
export interface MetadataApiInterface {
     ...
     */
    fetchSpecificProperties(accessToken: string,urn: string, modelGuid: string,region?:Region, acceptEncoding?: string, specificPropertiesPayload?: SpecificPropertiesPayload,  options?: ApsServiceRequestConfig): Promise<ApiResponse>;
     ...
     * @memberof MetadataApiInterface
     */
    getAllProperties(accessToken: string,urn: string, modelGuid: string, region?:Region,acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, objectid?: number, forceget?: string,  options?: ApsServiceRequestConfig): Promise<ApiResponse>;
     ...
     * @memberof MetadataApiInterface
     */
    getModelViews(accessToken: string,urn: string,region?:Region, acceptEncoding?: string,  options?: ApsServiceRequestConfig): Promise<ApiResponse>;
     ...
     * @memberof MetadataApiInterface
     */
    getObjectTree(accessToken: string,urn: string, modelGuid: string,region?:Region, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, forceget?: string, objectid?: number, level?: string,  options?: ApsServiceRequestConfig): Promise<ApiResponse>;
...
export class MetadataApi extends BaseAPI implements MetadataApiInterface {
     ...
     */
    public async fetchSpecificProperties(accessToken: string, urn: string, modelGuid: string,region?:Region, acceptEncoding?: string, specificPropertiesPayload?: SpecificPropertiesPayload, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into fetchSpecificProperties ");
      try {
        const request =  await MetadataApiFp(this.sdkManager).fetchSpecificProperties(accessToken, urn, modelGuid,region, acceptEncoding, specificPropertiesPayload,  options);
     ...
     * @memberof MetadataApi
     */
    public async getAllProperties(accessToken: string, urn: string, modelGuid: string, region?:Region, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, objectid?: number, forceget?: string, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into getAllProperties ");
      try {
        const request =  await MetadataApiFp(this.sdkManager).getAllProperties(accessToken, urn, modelGuid,region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget,  options);
        const response = await request(this.axios);
     ...
     * @memberof MetadataApi
     */
    public async getModelViews(accessToken: string, urn: string, region?:Region,acceptEncoding?: string, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into getModelViews ");
      try {
        const request =  await MetadataApiFp(this.sdkManager).getModelViews(accessToken, urn, region, acceptEncoding,  options);
        const response = await request(this.axios);
     ...
     * @memberof MetadataApi
     */
    public async getObjectTree(accessToken: string, urn: string, modelGuid: string, region?:Region,acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, forceget?: string, objectid?: number, level?: string, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into getObjectTree ");
      try {
        const request =  await MetadataApiFp(this.sdkManager).getObjectTree(accessToken, urn, modelGuid,region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level,  options);
        const response = await request(this.axios);
