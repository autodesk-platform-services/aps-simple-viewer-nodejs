 ...
 * @export
 */
export const JobsApiAxiosParamCreator = function (apsConfiguration) {
    return {
        /**
        ...
        specifyReferences: (accessToken, urn, specifyReferencesRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            const regionPath = Utils.GetPathfromRegion((_a = specifyReferencesRequest === null || specifyReferencesRequest === void 0 ? void 0 : specifyReferencesRequest.region) !== null && _a !== void 0 ? _a : Region.US);
        ...
        startJob: (accessToken, xAdsForce, xAdsDerivativeFormat, jobPayload, options = {}) => __awaiter(this, void 0, void 0, function* () {
            var _b, _c;
            const regionPath = Utils.GetPathfromRegion((_c = (_b = jobPayload.output.destination) === null || _b === void 0 ? void 0 : _b.region) !== null && _c !== void 0 ? _c : Region.US);
 ...
 * @export
 */
export const JobsApiFp = function (sdkManager) {
...
export class JobsApi extends BaseAPI {
    ...
    specifyReferences(accessToken, urn, specifyReferencesRequest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield JobsApiFp(this.sdkManager).specifyReferences(accessToken, urn, specifyReferencesRequest, options);
    ...
    startJob(accessToken, xAdsForce, xAdsDerivativeFormat, jobPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield JobsApiFp(this.sdkManager).startJob(accessToken, xAdsForce, xAdsDerivativeFormat, jobPayload, options);
                const response = yield request(this.axios);
