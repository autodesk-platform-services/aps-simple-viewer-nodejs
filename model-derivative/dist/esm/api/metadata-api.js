 ...
 * @export
 */
export const MetadataApiAxiosParamCreator = function (apsConfiguration) {
    return {
        /**
 ...
 * @export
 */
export const MetadataApiFp = function (sdkManager) {
...
export class MetadataApi extends BaseAPI {
    ...
    fetchSpecificProperties(accessToken, urn, modelGuid, region, acceptEncoding, specificPropertiesPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).fetchSpecificProperties(accessToken, urn, modelGuid, region, acceptEncoding, specificPropertiesPayload, options);
    ...
    getAllProperties(accessToken, urn, modelGuid, region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getAllProperties(accessToken, urn, modelGuid, region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options);
                const response = yield request(this.axios);
    ...
    getModelViews(accessToken, urn, region, acceptEncoding, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getModelViews(accessToken, urn, region, acceptEncoding, options);
                const response = yield request(this.axios);
    ...
    getObjectTree(accessToken, urn, modelGuid, region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getObjectTree(accessToken, urn, modelGuid, region, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options);
                const response = yield request(this.axios);
