...
export class OssClient {
     ...
     */
    public async createBucket(accessToken: string, xAdsRegion: CreateBucketXAdsRegionEnum, policyKey: CreateBucketsPayload): Promise<ApiResponse> {
        const response = await this.ossApi.createBucket(accessToken, xAdsRegion, policyKey);
        return response;
    }
  ...
  */
   ...
   public async getBuckets(accessToken: string, region?: GetBucketsRegionEnum, limit?: number, startAt?: string): Promise<ApiResponse>{
    ...
    public async getObjectDetails(accessToken: string, bucketKey: string, objectKey: string): Promise<ApiResponse>{
     ...
     * @memberof OSSApiInterface
     */
    public async getObjects(accessToken: string, bucketKey: string, limit?: number, beginsWith?: string, startAt?: string): Promise<ApiResponse>{
